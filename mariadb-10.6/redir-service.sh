...
echo "proxy Redirecting from $DEFAULT_IP:3307 to 127.0.0.1:3306 ..."
exec /usr/bin/network-proxy-server --listen-address first-ipv4 --listen-port 3307 --target-address 127.0.0.1 --target-port 3306
